---
title: "MyRouter — Uninstall Guide"
version: 3.8.40
lastUpdated: 2026-06-28
---

# MyRouter — Uninstall Guide
...
This guide covers how to cleanly remove MyRouter from your system.

---

## Quick Uninstall (v3.6.2+)

MyRouter provides two built-in scripts for clean removal:
...
This removes the MyRouter application but **preserves** your database, configurations, API keys, and provider settings in `~/.myrouter/`. Use this if you plan to reinstall later and want to keep your setup.
...
- Backup files
- Log files
- All files in the `~/.myrouter/` directory
...
- Open `Settings → Apps → MyRouter → Uninstall`
- Or run the NSIS uninstaller from the install directory

**macOS:**

- Drag `MyRouter.app` from `/Applications` to Trash
- Remove data: `rm -rf ~/Library/Application Support/myrouter`

**Linux:**

- Remove the AppImage file
- Remove data: `rm -rf ~/.myrouter`
...
MyRouter stores data in the following locations by default:
