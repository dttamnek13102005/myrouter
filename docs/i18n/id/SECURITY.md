...
Jika Anda menemukan kerentanan keamanan di MyRouter, harap laporkan secara bertanggung jawab:

1. **JANGAN** membuka isu GitHub yang bersifat publik
2. Gunakan [GitHub Security Advisories](https://github.com/diegosouzapw/MyRouter/security/advisories/new)
...
MyRouter menerapkan model keamanan berlapis:
