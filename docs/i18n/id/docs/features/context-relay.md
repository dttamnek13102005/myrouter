...
- sebelum akun aktif habis, MyRouter menghasilkan ringkasan terstruktur yang ringkas
- setelah autentikasi memilih akun berbeda untuk sesi yang sama, MyRouter menyuntikkan
...
Jika penyedia aktif diaktifkan di `handoffProviders`, MyRouter menghasilkan ringkasan handoff
...
MyRouter menambahkan handoff yang tersimpan sebagai pesan sistem. Penyuntikan hanya terjadi setelah
...
Pada saat penyuntikan, MyRouter mengonversi muatan tersebut menjadi pesan sistem `<context_handoff>`
