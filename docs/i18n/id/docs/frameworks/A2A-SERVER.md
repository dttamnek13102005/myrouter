# Dokumentasi Server A2A MyRouter (Bahasa Indonesia)
...
> Protokol Agent-to-Agent v0.3 — MyRouter sebagai agen routing cerdas
...
Mengembalikan Kartu Agen yang mendeskripsikan kemampuan, keterampilan, dan persyaratan autentikasi MyRouter.
...
| :----------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `smart-routing`    | Merutekan prompt melalui pipeline cerdas MyRouter. Mengembalikan respons beserta penjelasan routing, biaya, dan jejak ketahanan.                        |
