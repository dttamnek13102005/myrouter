# MyRouter — Panduan Deployment di VM dengan Cloudflare (Bahasa Indonesia)
...
Panduan lengkap untuk menginstal dan mengkonfigurasi MyRouter pada sebuah VM (VPS) dengan domain yang dikelola melalui Cloudflare.
...
Jaga agar timeout stream reverse-proxy tetap selaras dengan variabel lingkungan timeout MyRouter Anda. Jika Anda menaikkan
...
Lihat dokumentasi lengkap di [myrouterCloud/README.md](../myrouterCloud/README.md).
...
| 20128 | MyRouter   | Hanya localhost (melalui nginx) |
