---
title: "MyRouter — Przewodnik deinstalacji"
version: 3.8.40
lastUpdated: 2026-06-28
---

# MyRouter — Przewodnik deinstalacji
...
Ten przewodnik opisuje, jak czysto usunąć MyRouter z systemu.

---

## Szybka deinstalacja (v3.6.2+)

MyRouter udostępnia dwa wbudowane skrypty do czystego usunięcia:
...
To usuwa aplikację MyRouter, ale **zachowuje** bazę danych, konfiguracje, klucze API oraz ustawienia providerów w `~/.myrouter/`. Użyj tej opcji, jeśli planujesz ponowną instalację i chcesz zachować swoją konfigurację.
...
- Pliki logów
- Wszystkie pliki w katalogu `~/.myrouter/`
...
- Otwórz `Settings → Apps → MyRouter → Uninstall`
- Lub uruchom deinstalator NSIS z katalogu instalacji

**macOS:**

- Przeciągnij `MyRouter.app` z `/Applications` do Kosza
- Usuń dane: `rm -rf ~/Library/Application Support/myrouter`

**Linux:**

- Usuń plik AppImage
- Usuń dane: `rm -rf ~/.myrouter`
...
MyRouter domyślnie przechowuje dane w następujących lokalizacjach:
