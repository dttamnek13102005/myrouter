# MyRouter A2A Server Documentation (Português (Portugal))
...
| Skill              | Description                                                                                                                     |
| :----------------- | :------------------------------------------------------------------------------------------------------------------------------ |
| `smart-routing`    | Routes prompts through MyRouter's intelligent pipeline. Returns response with routing explanation, cost, and resilience trace. |
