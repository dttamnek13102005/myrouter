# CLI Tools Setup Guide — MyRouter (Português (Portugal))
...
to use **MyRouter** as the unified backend, giving you centralized key management,
...
1. Open the MyRouter dashboard → **API Manager** (`/dashboard/api-manager`)
...
> **Note:** Cursor routes requests through its cloud. For MyRouter integration,
> enable **Cloud Endpoint** in MyRouter Settings and use your public domain URL.

Via GUI: **Settings → Models → OpenAI API Key**

- Base URL: `https://your-domain.com/v1`
- API Key: your MyRouter key

---

## Dashboard Auto-Configuration

The MyRouter dashboard automates configuration for most tools:
...
**Droid** and **OpenClaw** are AI agents built directly into MyRouter — no installation needed.
They run as internal routes and use MyRouter's model routing automatically.
...
| Error                     | Cause                   | Fix                                        |
| ------------------------- | ----------------------- | ------------------------------------------ |
| `Connection refused`      | MyRouter not running   | `pm2 start myrouter`                      |
...
```bash
# Install all CLIs and configure for MyRouter (replace with your key and server URL)
