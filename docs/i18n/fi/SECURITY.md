...
If you discover a security vulnerability in MyRouter, please report it responsibly:

1. **DO NOT** open a public GitHub issue
2. Use [GitHub Security Advisories](https://github.com/diegosouzapw/MyRouter/security/advisories/new)
...
MyRouter implements a multi-layered security model:
