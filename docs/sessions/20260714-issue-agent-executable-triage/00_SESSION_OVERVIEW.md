...
Issue: `https://github.com/diegosouzapw/MyRouter/issues/5980`
PR: `https://github.com/diegosouzapw/MyRouter/pull/7002`

## Goal

Deliver GitHub issue #5980 as a production issue-agent workflow. The workflow
must execute recorded GitHub triage through MyRouter routing, persist a complete
...
| DEC-002     | Keep issue-agent execution opt-in with `MYROUTER_ISSUE_AGENT_ENABLED=true`      | prevents unrequested autonomous execution                                                                      | `implemented` |
