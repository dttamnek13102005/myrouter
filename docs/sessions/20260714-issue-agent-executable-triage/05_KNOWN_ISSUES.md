...
| -------- | -------- | ------ | ------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ------------------------- |
| KI-001   | P1       | `open` | `execution.ts` places `routingPolicy` in `X-MyRouter-Mode`; the researched chat route has no observed consumer in the AC1 path | AC1 does not yet prove configured routing policy affects routing                                                       | AC1 implementation/review |
