---
title: "MyRouter Documentation"
version: 3.8.40
lastUpdated: 2026-06-28
---

# MyRouter Documentation

Navigable index of the MyRouter documentation set. Topics are grouped by intent so you can find what you need quickly.
...
Simple guides for using MyRouter — no technical background needed.

### getting-started/

- [QUICK-START.md](getting-started/QUICK-START.md) — install and run MyRouter in 3 minutes.
- [AUTO-COMBO-GUIDE.md](getting-started/AUTO-COMBO-GUIDE.md) — let MyRouter pick the best AI for you.
...
- [SETUP_GUIDE.md](guides/SETUP_GUIDE.md) — first-time setup of MyRouter.
...
- [TIERS.md](guides/TIERS.md) — MyRouter tiers explained (user guide).
...
- [DOCKER_GUIDE.md](guides/DOCKER_GUIDE.md) — running MyRouter under Docker.
...
- [REMOTE-MODE.md](guides/REMOTE-MODE.md) — exposing MyRouter remotely + scoped tokens.
- [CLI-INTEGRATIONS.md](guides/CLI-INTEGRATIONS.md) — master table of `setup-*` CLI integrations.
- [CLAUDE-CODE-CONFIGURATION.md](guides/CLAUDE-CODE-CONFIGURATION.md) — Claude Code CLI with MyRouter.
- [CODEX-CLI-CONFIGURATION.md](guides/CODEX-CLI-CONFIGURATION.md) — Codex CLI with MyRouter.
...
- [MYROUTER_VS_ALTERNATIVES.md](comparison/MYROUTER_VS_ALTERNATIVES.md) — how MyRouter compares to alternatives.
