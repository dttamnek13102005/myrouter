...
> Last updated: 2026-06-28 — MyRouter v3.8.40
>
...
├── @myrouter/           # Publishable companion packages (opencode-plugin, opencode-provider)
├── skills/               # CLI/agent skill packs (cli-* + omni-* + config-codex-cli)
├── examples/             # Sample plugins + myrouter-cmd-hello starter
...
Separate npm workspace (`@myrouter/open-sse`). Handles request processing + provider execution.
...
| `preload.js`     | IPC bridge (contextBridge → `window.myrouter`)                                   |
...
| File                                                                                                        | Purpose                                                                                                                    |
| ----------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `myrouter.mjs`                                                                                             | Main CLI entry — `myrouter serve`, `myrouter setup`, `myrouter doctor`, `myrouter providers`, `myrouter combos`, etc. |
...
| File                         | Purpose                                                                            |
| ---------------------------- | ---------------------------------------------------------------------------------- |
| `skills/myrouter*/SKILL.md` | 10 skill manifests for external AI agents (Claude Desktop, ChatGPT, Cursor, Cline) |
...
| `CLI-TOOLS.md`              | External CLI integrations + Internal MyRouter CLI                                    |
...
- **`_mono_repo/`** — historic subprojects (myrouterCloud, myrouterSite, vscode-extension)
