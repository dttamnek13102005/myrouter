...
/**
 * write-build-sha.mjs — HEAD sentinel guard for MyRouter release builds.
 *
 * Writes MYROUTER_BUILD_SHA (or git rev-parse --short HEAD) into:
 *   - dist/BUILD_SHA
...
function resolveBuildSha() {
  if (process.env.MYROUTER_BUILD_SHA) {
    return process.env.MYROUTER_BUILD_SHA.trim();
  }
  try {
