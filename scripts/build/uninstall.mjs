...
const dataDir = process.env.DATA_DIR || path.join(os.homedir(), ".myrouter");
...
if (uninstallAlreadyInProgress) {
  ...
  try {
    execSync("npm uninstall -g myrouter", {
      stdio: "inherit",
      env: {
        ...process.env,
        MYROUTER_SKIP_UNINSTALL_HOOK: "1",
      },
    });
    console.log("\n✅ MyRouter has been successfully uninstalled from your system.");
    if (!fullUninstall) {
