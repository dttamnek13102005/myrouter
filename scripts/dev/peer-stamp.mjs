 ...
 * (MYROUTER_PEER_STAMP_TOKEN). Any client-supplied value of PEER_IP_HEADER is
...
export function ensurePeerStampToken() {
  process.env.MYROUTER_PEER_STAMP_TOKEN ||= randomUUID();
  return process.env.MYROUTER_PEER_STAMP_TOKEN;
}
