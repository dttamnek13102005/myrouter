...
// #2939: honor MYROUTER_MEMORY_MB (default 512), the same knob
// `myrouter serve` uses, so Docker users can control the server heap under
...
const maxOldSpaceMb = resolveMaxOldSpaceMb(childEnv.MYROUTER_MEMORY_MB);
