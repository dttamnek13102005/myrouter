...
// Estas rotas NÃO consultam o DB do MyRouter (getDbInstance) — elas abrem o
// SQLite de OUTRO aplicativo (Cursor / Kiro) para auto-importar credenciais.
// Por isso NÃO podem viver em src/lib/db/ (que é o domínio do DB do MyRouter):
...
// QUALQUER novo SQL cru contra o DB do MyRouter em rotas/handlers.
