...
const MESSAGE_OVERRIDES = {
  es: {
    ...
    "auth.stopServer": "Detén el servidor MyRouter",
  ...
  ja: {
    ...
    "auth.stopServer": "MyRouter サーバーを停止",
...
const README_NAV_OVERRIDES = {
  "README.ja.md":
    "[🌐 ウェブサイト](https://myrouter.online) • [🚀 クイックスタート](#-クイックスタート) • [💡 主な機能](#-主な機能) • [📖 ドキュメント](#-ドキュメント) • [💰 料金](#-価格の概要) • [💬 WhatsApp](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)",
  "README.ar.md":
    "[🌐 الموقع](https://myrouter.online) • [🚀 البداية السريعة](#-بداية-سريعة) • [💡 الميزات](#-الميزات-الرئيسية) • [📖 التوثيق](#-التوثيق) • [💰 الأسعار](#-لمحة-سريعة-عن-الأسعار) • [💬 WhatsApp](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)",
};
...
function removeEnglishPortugueseAnchorLine(content) {
  ...
  const filtered = lines.filter(
    (line) =>
      !line.includes(
        "**[English](#-myrouter--the-free-ai-gateway)** | **[Português (BR)](#-myrouter--gateway-de-ia-gratuito)**"
      )
  );
