 ...
 *
 * Reusable Phase-3 VPS HTTP client for MyRouter combo live-smoke tests.
 ...
 *   execFileSync("ssh", ["root@192.168.0.15", "sqlite3", "/root/.myrouter/storage.sqlite", SQL])
...
const VPS_DB_PATH = "/root/.myrouter/storage.sqlite";
...
if (isMain) {
  (async () => {
    console.log("=== MyRouter VPS Phase-3 Preflight ===");
