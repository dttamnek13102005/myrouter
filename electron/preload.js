/**
 * MyRouter Electron Desktop App - Preload Script
 *
...
const MAC_DRAG_STYLE_ID = "myrouter-electron-drag-region-style";
const MAC_DRAG_FALLBACK_ID = "myrouter-electron-drag-region";
const MAC_DRAG_OBSERVER_KEY = "__myrouterMacDragRegionObserver";
...
function installMacDragRegion() {
  ...
  const attach = () => {
    ...
    dragRegion.className = "myrouter-electron-drag-region";
