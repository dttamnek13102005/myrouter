...
export function createProgram() {
  ...
  program
    ...
    .addOption(new Option("--api-key <key>", t("program.api_key")).env("MYROUTER_API_KEY"))
    .addOption(new Option("--base-url <url>", t("program.base_url")).env("MYROUTER_BASE_URL"))
    .addOption(
      new Option(
        "--context <name>",
        t("program.context") || "Server context/profile to use for this command"
      ).env("MYROUTER_CONTEXT")
    )
