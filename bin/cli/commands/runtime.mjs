...
/**
 * Shared repair action used by both `myrouter runtime repair` and the
 * top-level `myrouter repair` alias. Reinstalls better-sqlite3 into the
...
export function registerRuntime(program) {
  ...
  // Top-level discoverability alias: `myrouter repair` invokes the SAME action
  // as `myrouter runtime repair` (no duplicated logic). Surfaced in the
