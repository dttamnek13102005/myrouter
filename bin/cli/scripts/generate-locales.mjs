...
const TRANSLATIONS = {
  ar: {
    common: {
      error: "خطأ: {message}",
      serverOffline: "خادم MyRouter غير متصل. ابدأ بالأمر: myrouter serve",
      authRequired: "المصادقة مطلوبة. عيّن MYROUTER_API_KEY أو شغّل: myrouter setup",
    ...
    program: {
      description: "MyRouter — جهاز توجيه الذكاء الاصطناعي مع التبديل التلقائي",
      ...
      api_key: "مفتاح API لخادم MyRouter",
      base_url: "عنوان URL الأساسي لخادم MyRouter",
      context: "سياق/ملف تعريف الخادم المستخدم في هذا الأمر",
      lang: "تعيين لغة عرض CLI (يتجاوز MYROUTER_LANG)",
    },
  },
  az: {
    common: {
      error: "Xəta: {message}",
      serverOffline: "MyRouter serveri oflayndır. Başladın: myrouter serve",
      authRequired:
        "Autentifikasiya tələb olunur. MYROUTER_API_KEY təyin edin və ya işə salın: myrouter setup",
    ...
    program: {
      description: "MyRouter — Avtomatik Fallback ilə Ağıllı AI Marşrutlaşdırıcısı",
      ...
      api_key: "MyRouter serveri üçün API açarı",
      base_url: "MyRouter server baza URL-i",
      context: "Bu əmr üçün server konteksti/profili",
      lang: "CLI ekran dilini təyin edin (MYROUTER_LANG-ı keçir)",
    },
  },
  bg: {
    common: {
      error: "Грешка: {message}",
      serverOffline: "Сървърът MyRouter е офлайн. Стартирайте с: myrouter serve",
      authRequired:
        "Необходима е автентикация. Задайте MYROUTER_API_KEY или изпълнете: myrouter setup",
    ...
    program: {
      description: "MyRouter — Интелигентен AI рутер с автоматично превключване",
      ...
      api_key: "API ключ за сървъра MyRouter",
      base_url: "Базов URL на сървъра MyRouter",
      context: "Контекст/профил на сървъра за тази команда",
      lang: "Задай език на CLI (замества MYROUTER_LANG)",
    },
  },
  cs: {
    common: {
      error: "Chyba: {message}",
      serverOffline: "Server MyRouter je offline. Spusťte: myrouter serve",
      authRequired: "Vyžaduje se ověření. Nastavte MYROUTER_API_KEY nebo spusťte: myrouter setup",
    ...
    program: {
      description: "MyRouter — Chytrý AI router s automatickým přepínáním",
      ...
      api_key: "API klíč pro server MyRouter",
      base_url: "Základní URL serveru MyRouter",
      context: "Kontext/profil serveru pro tento příkaz",
      lang: "Nastavit jazyk CLI (přepisuje MYROUTER_LANG)",
    },
  },
  da: {
    common: {
      error: "Fejl: {message}",
      serverOffline: "MyRouter-serveren er offline. Start med: myrouter serve",
      authRequired: "Godkendelse kræves. Sæt MYROUTER_API_KEY eller kør: myrouter setup",
    ...
    program: {
      description: "MyRouter — Smart AI-router med automatisk fallback",
      ...
      api_key: "API-nøgle til MyRouter-serveren",
      base_url: "MyRouter-serverens basis-URL",
      context: "Server-kontekst/profil til denne kommando",
      lang: "Angiv CLI-visningssprog (tilsidesætter MYROUTER_LANG)",
    },
  },
  de: {
    common: {
      error: "Fehler: {message}",
      serverOffline: "MyRouter-Server ist offline. Starten mit: myrouter serve",
      authRequired:
        "Authentifizierung erforderlich. MYROUTER_API_KEY setzen oder ausführen: myrouter setup",
    ...
    program: {
      description: "MyRouter — Intelligenter AI-Router mit automatischem Fallback",
      ...
      api_key: "API-Schlüssel für den MyRouter-Server",
      base_url: "MyRouter-Server-Basis-URL",
      context: "Server-Kontext/Profil für diesen Befehl",
      lang: "CLI-Anzeigesprache festlegen (überschreibt MYROUTER_LANG)",
    },
  },
  es: {
    common: {
      error: "Error: {message}",
      serverOffline: "El servidor MyRouter está offline. Inícielo con: myrouter serve",
      authRequired:
        "Autenticación requerida. Configure MYROUTER_API_KEY o ejecute: myrouter setup",
    ...
    program: {
      description: "MyRouter — Router de IA inteligente con fallback automático",
      ...
      api_key: "Clave de API para el servidor MyRouter",
      base_url: "URL base del servidor MyRouter",
      context: "Contexto/perfil del servidor para este comando",
      lang: "Establecer idioma del CLI (reemplaza MYROUTER_LANG)",
    },
  },
  fa: {
    common: {
      error: "خطا: {message}",
      serverOffline: "سرور MyRouter آفلاین است. با این دستور راه‌اندازی کنید: myrouter serve",
      authRequired:
        "احراز هویت لازم است. MYROUTER_API_KEY را تنظیم کنید یا اجرا کنید: myrouter setup",
    ...
    program: {
      description: "MyRouter — روتر هوشمند هوش مصنوعی با fallback خودکار",
      ...
      api_key: "کلید API برای سرور MyRouter",
      base_url: "URL پایه سرور MyRouter",
      context: "زمینه/پروفایل سرور برای این دستور",
      lang: "تنظیم زبان نمایش CLI (MYROUTER_LANG را نادیده می‌گیرد)",
    },
  },
  fi: {
    common: {
      error: "Virhe: {message}",
      serverOffline: "MyRouter-palvelin on offline. Käynnistä komennolla: myrouter serve",
      authRequired: "Todennus vaaditaan. Aseta MYROUTER_API_KEY tai suorita: myrouter setup",
    ...
    program: {
      description: "MyRouter — Älykäs AI-reititin automaattisella fallbackilla",
      ...
      api_key: "API-avain MyRouter-palvelimelle",
      base_url: "MyRouter-palvelimen perus-URL",
      context: "Palvelimen konteksti/profiili tälle komennolle",
      lang: "Aseta CLI-näyttökieli (ohittaa MYROUTER_LANG)",
    },
  },
  fr: {
    common: {
      error: "Erreur : {message}",
      serverOffline: "Le serveur MyRouter est hors ligne. Démarrez avec : myrouter serve",
      authRequired:
        "Authentification requise. Définissez MYROUTER_API_KEY ou exécutez : myrouter setup",
    ...
    program: {
      description: "MyRouter — Routeur IA intelligent avec basculement automatique",
      ...
      api_key: "Clé API pour le serveur MyRouter",
      base_url: "URL de base du serveur MyRouter",
      context: "Contexte/profil du serveur pour cette commande",
      lang: "Définir la langue d'affichage du CLI (remplace MYROUTER_LANG)",
    },
  },
  hi: {
    common: {
      error: "त्रुटि: {message}",
      serverOffline: "MyRouter सर्वर ऑफलाइन है। शुरू करें: myrouter serve",
      authRequired: "प्रमाणीकरण आवश्यक है। MYROUTER_API_KEY सेट करें या चलाएं: myrouter setup",
    ...
    program: {
      description: "MyRouter — ऑटो फॉलबैक के साथ स्मार्ट AI राउटर",
      ...
      api_key: "MyRouter सर्वर के लिए API कुंजी",
      base_url: "MyRouter सर्वर का बेस URL",
      context: "इस कमांड के लिए सर्वर संदर्भ/प्रोफ़ाइल",
      lang: "CLI प्रदर्शन भाषा सेट करें (MYROUTER_LANG को ओवरराइड करता है)",
    },
  },
  hu: {
    common: {
      error: "Hiba: {message}",
      serverOffline: "Az MyRouter szerver offline. Indítsa el: myrouter serve",
      authRequired:
        "Hitelesítés szükséges. Állítsa be az MYROUTER_API_KEY-t vagy futtassa: myrouter setup",
    ...
    program: {
      description: "MyRouter — Intelligens AI útválasztó automatikus fallbackkel",
      ...
      api_key: "API kulcs az MyRouter szerverhez",
      base_url: "Az MyRouter szerver alap URL-je",
      context: "Szerverkontextus/profil ehhez a parancshoz",
      lang: "CLI megjelenítési nyelv beállítása (felülírja az MYROUTER_LANG-ot)",
    },
  },
  id: {
    common: {
      error: "Kesalahan: {message}",
      serverOffline: "Server MyRouter sedang offline. Mulai dengan: myrouter serve",
      authRequired:
        "Autentikasi diperlukan. Setel MYROUTER_API_KEY atau jalankan: myrouter setup",
    ...
    program: {
      description: "MyRouter — Router AI Cerdas dengan Fallback Otomatis",
      ...
      api_key: "Kunci API untuk server MyRouter",
      base_url: "URL dasar server MyRouter",
      context: "Konteks/profil server untuk perintah ini",
      lang: "Atur bahasa tampilan CLI (menggantikan MYROUTER_LANG)",
    },
  },
  it: {
    common: {
      error: "Errore: {message}",
      serverOffline: "Il server MyRouter è offline. Avviarlo con: myrouter serve",
      authRequired:
        "Autenticazione richiesta. Impostare MYROUTER_API_KEY o eseguire: myrouter setup",
    ...
    program: {
      description: "MyRouter — Router AI intelligente con fallback automatico",
      ...
      api_key: "Chiave API per il server MyRouter",
      base_url: "URL base del server MyRouter",
      context: "Contesto/profilo del server per questo comando",
      lang: "Imposta la lingua di visualizzazione della CLI (sovrascrive MYROUTER_LANG)",
    },
  },
  ja: {
    common: {
      error: "エラー: {message}",
      serverOffline: "MyRouterサーバーはオフラインです。起動: myrouter serve",
      authRequired:
        "認証が必要です。MYROUTER_API_KEYを設定するか実行してください: myrouter setup",
    ...
    program: {
      description: "MyRouter — 自動フォールバック付きスマートAIルーター",
      version: "バージョンを表示して終了",
      output: "出力形式 (table, json, jsonl, csv)",
      quiet: "重要でない出力を抑制",
      no_color: "カラー出力を無効化",
      timeout: "HTTPリクエストタイムアウト（ミリ秒）",
      api_key: "MyRouterサーバーのAPIキー",
      base_url: "MyRouterサーバーのベースURL",
      context: "このコマンドで使用するサーバーコンテキスト/プロファイル",
      lang: "CLI表示言語を設定（MYROUTER_LANGを上書き）",
    },
  },
  ko: {
    common: {
      error: "오류: {message}",
      serverOffline: "MyRouter 서버가 오프라인입니다. 시작: myrouter serve",
      authRequired: "인증이 필요합니다. MYROUTER_API_KEY를 설정하거나 실행하세요: myrouter setup",
    ...
    program: {
      description: "MyRouter — 자동 폴백 기능을 갖춘 스마트 AI 라우터",
      version: "버전 출력 후 종료",
      output: "출력 형식 (table, json, jsonl, csv)",
      quiet: "불필요한 출력 억제",
      no_color: "색상 출력 비활성화",
      timeout: "HTTP 요청 타임아웃(밀리초)",
      api_key: "MyRouter 서버의 API 키",
      base_url: "MyRouter 서버 기본 URL",
      context: "이 명령에 사용할 서버 컨텍스트/프로필",
      lang: "CLI 표시 언어 설정 (MYROUTER_LANG 재정의)",
    },
  },
  nl: {
    common: {
      error: "Fout: {message}",
      serverOffline: "MyRouter-server is offline. Start met: myrouter serve",
      authRequired: "Authenticatie vereist. Stel MYROUTER_API_KEY in of voer uit: myrouter setup",
    ...
    program: {
      description: "MyRouter — Slimme AI-router met automatische fallback",
      ...
      api_key: "API-sleutel voor de MyRouter-server",
      base_url: "Basis-URL van de MyRouter-server",
      context: "Servercontext/profiel voor dit commando",
      lang: "CLI-weergavetaal instellen (overschrijft MYROUTER_LANG)",
    },
  },
  no: {
    common: {
      error: "Feil: {message}",
      serverOffline: "MyRouter-serveren er offline. Start med: myrouter serve",
      authRequired: "Autentisering kreves. Angi MYROUTER_API_KEY eller kjør: myrouter setup",
    ...
    program: {
      description: "MyRouter — Smart AI-ruter med automatisk fallback",
      ...
      api_key: "API-nøkkel for MyRouter-serveren",
      base_url: "MyRouter-serverens basis-URL",
      context: "Serverkontekst/profil for denne kommandoen",
      lang: "Angi CLI-visningsspråk (overstyrer MYROUTER_LANG)",
    },
  },
  pl: {
    common: {
      error: "Błąd: {message}",
      serverOffline: "Serwer MyRouter jest offline. Uruchom: myrouter serve",
      authRequired:
        "Wymagane uwierzytelnienie. Ustaw MYROUTER_API_KEY lub uruchom: myrouter setup",
    ...
    program: {
      description: "MyRouter — Inteligentny router AI z automatycznym fallbackiem",
      ...
      api_key: "Klucz API dla serwera MyRouter",
      base_url: "Bazowy URL serwera MyRouter",
      context: "Kontekst/profil serwera dla tego polecenia",
      lang: "Ustaw język wyświetlania CLI (nadpisuje MYROUTER_LANG)",
    },
  },
  pt: {
    common: {
      error: "Erro: {message}",
      serverOffline: "O servidor MyRouter está offline. Inicie com: myrouter serve",
      authRequired: "Autenticação necessária. Defina MYROUTER_API_KEY ou execute: myrouter setup",
    ...
    program: {
      description: "MyRouter — Router de IA inteligente com fallback automático",
      ...
      api_key: "Chave de API para o servidor MyRouter",
      base_url: "URL base do servidor MyRouter",
      context: "Contexto/perfil do servidor para este comando",
      lang: "Definir idioma de apresentação do CLI (substitui MYROUTER_LANG)",
    },
  },
  ro: {
    common: {
      error: "Eroare: {message}",
      serverOffline: "Serverul MyRouter este offline. Porniți cu: myrouter serve",
      authRequired: "Autentificare necesară. Setați MYROUTER_API_KEY sau rulați: myrouter setup",
    ...
    program: {
      description: "MyRouter — Router AI inteligent cu fallback automat",
      ...
      api_key: "Cheie API pentru serverul MyRouter",
      base_url: "URL de bază al serverului MyRouter",
      context: "Contextul/profilul serverului pentru această comandă",
      lang: "Setează limba de afișare CLI (suprascrie MYROUTER_LANG)",
    },
  },
  ru: {
    common: {
      error: "Ошибка: {message}",
      serverOffline: "Сервер MyRouter отключён. Запустите: myrouter serve",
      authRequired:
        "Требуется аутентификация. Установите MYROUTER_API_KEY или выполните: myrouter setup",
    ...
    program: {
      description: "MyRouter — Умный AI-маршрутизатор с автоматическим переключением",
      ...
      api_key: "API-ключ для сервера MyRouter",
      base_url: "Базовый URL сервера MyRouter",
      context: "Контекст/профиль сервера для этой команды",
      lang: "Установить язык отображения CLI (переопределяет MYROUTER_LANG)",
    },
  },
  sk: {
    common: {
      error: "Chyba: {message}",
      serverOffline: "Server MyRouter je offline. Spustite: myrouter serve",
      authRequired:
        "Vyžaduje sa overenie. Nastavte MYROUTER_API_KEY alebo spustite: myrouter setup",
    ...
    program: {
      description: "MyRouter — Inteligentný AI router s automatickým prepínaním",
      ...
      api_key: "API kľúč pre server MyRouter",
      base_url: "Základná URL servera MyRouter",
      context: "Kontext/profil servera pre tento príkaz",
      lang: "Nastaviť jazyk zobrazenia CLI (prepíše MYROUTER_LANG)",
    },
  },
  sv: {
    common: {
      error: "Fel: {message}",
      serverOffline: "MyRouter-servern är offline. Starta med: myrouter serve",
      authRequired: "Autentisering krävs. Ange MYROUTER_API_KEY eller kör: myrouter setup",
    ...
    program: {
      ...
      api_key: "API-nyckel för MyRouter-servern",
      base_url: "MyRouter-serverns bas-URL",
      context: "Serverkontext/profil för det här kommandot",
      lang: "Ange CLI-visningsspråk (åsidosätter MYROUTER_LANG)",
    },
  },
  th: {
    common: {
      error: "ข้อผิดพลาด: {message}",
      serverOffline: "เซิร์ฟเวอร์ MyRouter ออฟไลน์ เริ่มด้วย: myrouter serve",
      authRequired: "ต้องการการยืนยันตัวตน ตั้งค่า MYROUTER_API_KEY หรือรัน: myrouter setup",
    ...
    program: {
      description: "MyRouter — AI Router อัจฉริยะพร้อม Auto Fallback",
      ...
      api_key: "API Key สำหรับ MyRouter server",
      base_url: "Base URL ของ MyRouter server",
      context: "บริบท/โปรไฟล์ของเซิร์ฟเวอร์สำหรับคำสั่งนี้",
      lang: "ตั้งค่าภาษาแสดงผล CLI (แทนที่ MYROUTER_LANG)",
    },
  },
  tr: {
    common: {
      error: "Hata: {message}",
      serverOffline: "MyRouter sunucusu çevrimdışı. Başlatın: myrouter serve",
      authRequired:
        "Kimlik doğrulama gerekli. MYROUTER_API_KEY ayarlayın veya çalıştırın: myrouter setup",
    ...
    program: {
      description: "MyRouter — Otomatik Fallback ile Akıllı AI Yönlendirici",
      ...
      api_key: "MyRouter sunucusu için API anahtarı",
      base_url: "MyRouter sunucusu temel URL'si",
      context: "Bu komut için sunucu bağlamı/profili",
      lang: "CLI görüntüleme dilini ayarla (MYROUTER_LANG'ı geçersiz kılar)",
    },
  },
  "uk-UA": {
    common: {
      error: "Помилка: {message}",
      serverOffline: "Сервер MyRouter відключено. Запустіть: myrouter serve",
      authRequired:
        "Потрібна автентифікація. Встановіть MYROUTER_API_KEY або виконайте: myrouter setup",
    ...
    program: {
      description: "MyRouter — Розумний AI-маршрутизатор з автоматичним перемиканням",
      ...
      api_key: "API-ключ для сервера MyRouter",
      base_url: "Базовий URL сервера MyRouter",
      context: "Контекст/профіль сервера для цієї команди",
      lang: "Встановити мову відображення CLI (замінює MYROUTER_LANG)",
    },
  },
  vi: {
    common: {
      error: "Lỗi: {message}",
      serverOffline: "Máy chủ MyRouter đang offline. Khởi động với: myrouter serve",
      authRequired: "Cần xác thực. Đặt MYROUTER_API_KEY hoặc chạy: myrouter setup",
    ...
    program: {
      description: "MyRouter — Bộ định tuyến AI thông minh với tự động chuyển đổi dự phòng",
      ...
      api_key: "Khóa API cho máy chủ MyRouter",
      base_url: "URL cơ sở của máy chủ MyRouter",
      context: "Bối cảnh/hồ sơ máy chủ cho lệnh này",
      lang: "Đặt ngôn ngữ hiển thị CLI (ghi đè MYROUTER_LANG)",
    },
  },
  "zh-CN": {
    common: {
      error: "错误：{message}",
      serverOffline: "MyRouter 服务器已离线。请启动：myrouter serve",
      authRequired: "需要认证。请设置 MYROUTER_API_KEY 或运行：myrouter setup",
    ...
    program: {
      description: "MyRouter — 具有自动故障转移的智能 AI 路由器",
      version: "打印版本并退出",
      output: "输出格式（table, json, jsonl, csv）",
      quiet: "禁止非必要输出",
      no_color: "禁用彩色输出",
      timeout: "HTTP 请求超时（毫秒）",
      api_key: "MyRouter 服务器的 API 密钥",
      base_url: "MyRouter 服务器的基础 URL",
      context: "此命令使用的服务器上下文/配置文件",
      lang: "设置 CLI 显示语言（覆盖 MYROUTER_LANG）",
    },
  },
};
