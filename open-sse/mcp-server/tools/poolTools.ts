/**
 * MyRouter MCP Session Pool Tools — Manage and monitor anonymous web session pools.
 *
 * Tools:
 *   1. myrouter_pool_status   — Get pool stats for one or all providers
 *   2. myrouter_pool_sessions — List per-session details for a provider's pool
 *   3. myrouter_pool_reset    — Shut down and recreate a pool
 *   4. myrouter_pool_warm     — Warm up a pool to a target session count
 *   5. myrouter_pool_health   — Aggregated pool health with breaker state and issues
 */
...
export const poolTools = {
  myrouter_pool_status: {
    name: "myrouter_pool_status",
    description:
  ...
  myrouter_pool_sessions: {
    name: "myrouter_pool_sessions",
    description:
  ...
  myrouter_pool_health: {
    name: "myrouter_pool_health",
    description:
  ...
  myrouter_browser_pool_status: {
    name: "myrouter_browser_pool_status",
    description:
