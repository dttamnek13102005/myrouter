/**
 * MCP Tool Schemas — Contracts for all 23 core and advanced MyRouter MCP tools.
 *
 ...
 *
 * Each tool wraps existing MyRouter API endpoints and exposes them through
...
export const getHealthTool: McpToolDefinition<typeof getHealthInput, typeof getHealthOutput> = {
  name: "myrouter_get_health",
  description:
    "Returns the current health status of MyRouter including uptime, memory usage, circuit breaker states for all providers, rate limit status, and cache statistics.",
...
// --- Tool 3: myrouter_get_combo_metrics ---
...
> = {
  name: "myrouter_get_combo_metrics",
  description:
...
> = {
  ...
  description:
    "Sends a chat completion request through MyRouter's intelligent routing pipeline. Supports combo selection, budget limits, and task role hints for optimal provider matching.",
...
// --- Tool 8: myrouter_list_models_catalog ---
...
> = {
  name: "myrouter_list_models_catalog",
  description:
...
export const webSearchTool: McpToolDefinition<typeof webSearchInput, typeof webSearchOutput> = {
  name: "myrouter_web_search",
  description:
    "Performs a web search using MyRouter's search gateway. Supports multiple providers (Serper, Brave, Perplexity, Exa, Tavily, Google PSE, Linkup, SearchAPI, SearXNG) with automatic failover. Returns search results with titles, URLs, snippets, and position data.",
...
export const webFetchTool: McpToolDefinition<typeof webFetchInput, typeof webFetchOutput> = {
  name: "myrouter_web_fetch",
  description:
    "Fetches and extracts content from a URL using MyRouter's web fetch gateway. Supports multiple providers (Firecrawl, Jina Reader, Tavily, TinyFish) with automatic failover. Returns the page content as markdown, HTML, links, or screenshot, along with metadata.",
...
// --- Tool 9: myrouter_simulate_route ---
...
// --- Tool 10: myrouter_set_budget_guard ---
...
> = {
  name: "myrouter_set_budget_guard",
  description:
...
// --- Tool 11: myrouter_set_routing_strategy ---
...
> = {
  name: "myrouter_set_routing_strategy",
  description:
...
// --- Tool 12: myrouter_set_resilience_profile ---
...
> = {
  name: "myrouter_set_resilience_profile",
  description:
...
// --- Tool 14: myrouter_get_provider_metrics ---
...
> = {
  name: "myrouter_get_provider_metrics",
  description:
...
// --- Tool 15: myrouter_best_combo_for_task ---
...
> = {
  name: "myrouter_best_combo_for_task",
  description:
...
// --- Tool 16: myrouter_explain_route ---
...
// --- Tool 17: myrouter_get_session_snapshot ---
...
> = {
  name: "myrouter_get_session_snapshot",
  description:
...
// --- Tool 18: myrouter_db_health_check ---
...
> = {
  name: "myrouter_db_health_check",
  description:
    "Diagnoses MyRouter database drift such as orphan quota/domain rows, invalid JSON state, and broken combo references. Set autoRepair=true to repair those rows before returning the report.",
...
export const syncPricingTool: McpToolDefinition<typeof syncPricingInput, typeof syncPricingOutput> =
  {
    name: "myrouter_sync_pricing",
    description:
      "Syncs pricing data from external sources (LiteLLM) into MyRouter. Synced pricing fills gaps not covered by hardcoded defaults without overwriting user-set prices. Use dryRun=true to preview.",
...
> = {
  name: "myrouter_compression_status",
  description:
...
> = {
  name: "myrouter_compression_configure",
  description:
...
> = {
  name: "myrouter_set_compression_engine",
...
> = {
  name: "myrouter_list_compression_combos",
...
> = {
  name: "myrouter_compression_combo_stats",
...
> = {
  name: "myrouter_agent_skills_list",
  description:
    "List MyRouter agent skills with optional filtering by category (api/cli) or area. Returns skill metadata including id, name, description, endpoints/commands, and URLs.",
...
> = {
  name: "myrouter_agent_skills_get",
  description:
...
// --- myrouter_agent_skills_coverage ---
...
> = {
  name: "myrouter_agent_skills_coverage",
  description:
