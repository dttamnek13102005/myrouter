...
// local `droid` CLI. MyRouter already integrates Droid as a CLI tool at
...
// Factory Droids subscription can proxy traffic through MyRouter.
//
...
// back to stored CLI credentials only when omitted. MyRouter does NOT read
