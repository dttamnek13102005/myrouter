...
// MYROUTER_CIRCUIT_BREAKER_* env vars so operators can dampen or harden
...
export const PROVIDER_PROFILES = {
  oauth: {
    ...
    circuitBreakerThreshold: envInt("MYROUTER_CIRCUIT_BREAKER_OAUTH_THRESHOLD", 8),
    circuitBreakerReset: envInt("MYROUTER_CIRCUIT_BREAKER_OAUTH_RESET_MS", 60000),
  ...
  apikey: {
    ...
    circuitBreakerThreshold: envInt("MYROUTER_CIRCUIT_BREAKER_API_KEY_THRESHOLD", 12),
    circuitBreakerReset: envInt("MYROUTER_CIRCUIT_BREAKER_API_KEY_RESET_MS", 30000),
    // Provider-level circuit breaker (entire provider cooldown after repeated failures)
  ...
  local: {
    ...
    circuitBreakerThreshold: envInt("MYROUTER_CIRCUIT_BREAKER_LOCAL_THRESHOLD", 2),
    circuitBreakerReset: envInt("MYROUTER_CIRCUIT_BREAKER_LOCAL_RESET_MS", 15000),
    // Provider-level circuit breaker (entire provider cooldown after repeated failures)
 ...
 * In MyRouter the holdback is disabled by default because buffering the opening
