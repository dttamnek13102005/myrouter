 ...
 */
import { buildErrorBody } from "@myrouter/open-sse/utils/error.ts";
import { getCircuitBreaker } from "@/shared/utils/circuitBreaker";
import { isModelLocked } from "@myrouter/open-sse/services/accountFallback.ts";
...
export async function getAutoComboCandidates(
  ...
  if (channel === "auto") {
    ...
    const { createBuiltinAutoCombo } =
      await import("@myrouter/open-sse/services/autoCombo/builtinCatalog.ts");
