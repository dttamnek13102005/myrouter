 ...
 * to OpenAI Chat Completions chunks by reusing MyRouter's own translators
 ...
 * adapted to TypeScript + MyRouter's BaseExecutor/translator conventions.
...
function resolveZedSuppressThinkClose(
  ...
  return resolveSuppressThinkClose({
    ...
    thinkingMarkerHeader:
      ...
      clientHeaders?.["x-myrouter-thinking-marker"] ??
      null,
    ...
    const response = await zedLlmFetch(zedCredentials, "/completions", {
      ...
      fetchOptions: {
        ...
        headers: {
          ...
          "User-Agent": `MyRouter/zed-hosted`,
