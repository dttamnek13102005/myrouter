 ...
 * (Anthropic's current model migration guidance). MyRouter can still produce a manual
 ...
 * This contract is verified for MyRouter's two direct Anthropic API providers:
