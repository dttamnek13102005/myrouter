...
export interface ResolveAutoStrategyDeps {
  ...
  relayOptions?: {
    ...
    sessionId?: string | null;
    /** Per-request X-MyRouter-Mode value (#6024/#6025). */
    mode?: string | null;
    /** Per-request X-MyRouter-Budget value in USD (#6023). */
    budgetCap?: number | null;
    /** Per-request X-MyRouter-Budget-Fallback value ("cheapest" | "strict") — #3470. */
...
export async function resolveAutoStrategyOrder(
  ...
  // Per-request overrides (#6023 / #6024 / #6025 / #3470): X-MyRouter-Budget,
  // X-MyRouter-Budget-Fallback and X-MyRouter-Mode headers (threaded via
  ...
  // per-request X-MyRouter-Mode override — but `scoreAutoTargets()` (the fallback
