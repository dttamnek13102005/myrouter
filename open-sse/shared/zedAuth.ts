 ...
 *
 *   1. The client (MyRouter) generates an ephemeral RSA keypair.
 ...
 *   5. MyRouter decrypts the access token locally with the private key that
 ...
 * adapted to TypeScript + MyRouter conventions. `fetch` is intentionally the
