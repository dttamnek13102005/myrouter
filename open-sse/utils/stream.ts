...
import { buildMyRouterSseMetadataComment } from "@/domain/myrouterResponseMeta";
import {
...
export const PENDING_REQUEST_CLEARED_MARKER = "__myrouterPendingRequestCleared";
            ...
            if (trimmed.startsWith("data:") && trimmed.slice(5).trim() !== "[DONE]") {
              try {
                ...
                if (isResponsesSSE) {
                  ...
                  // chunk like "[MyRouter] Upstream returned an empty response. Please
