...
const PATCH_STATE_KEY = Symbol.for("myrouter.proxyFetch.state");
 ...
 *
 * This remains disabled unless MYROUTER_CONTROL_PLANE_PROXY_DIRECT_FALLBACK is enabled
...
async function patchedFetch(
  ...
  if (
    ...
    if (process.env.MYROUTER_PROXY_FETCH_DEBUG === "true") {
