...
const ENCRYPTED_REASONING_PLACEHOLDER =
  "Codex is reasoning, but the upstream Responses API exposed this reasoning block only as encrypted private reasoning. MyRouter cannot recover the plaintext.";
