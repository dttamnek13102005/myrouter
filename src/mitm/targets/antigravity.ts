...
export const ANTIGRAVITY_MITM_PROFILE: MitmTarget & {
  ...
  ...ANTIGRAVITY_TARGET,
  description:
    "Intercepts Antigravity IDE requests to cloudcode-pa.googleapis.com and routes them through MyRouter.",
  targetHost: HOSTS[0],
  targetPort: 443,
  localPort: 443,
