 ...
 *     is set explicitly. The MyRouter LOCAL_ONLY rule is enforced at the
...
declare global {
  var __myrouterEmbedWsStarted: boolean | undefined;
}
...
export function initEmbedWsProxy(): void {
  if (globalThis.__myrouterEmbedWsStarted) return;
  ...
  server.listen(port, host, () => {
    globalThis.__myrouterEmbedWsStarted = true;
