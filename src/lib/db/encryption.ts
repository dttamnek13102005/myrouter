 ...
 * The PRIMARY key is now derived with a static salt ("myrouter-field-encryption-v1").
 ...
 * a different derived key than the static salt `"myrouter-field-encryption-v1"`. When the
