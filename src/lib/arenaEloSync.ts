...
/**
 * Maps Arena leaderboard categories to MyRouter task-type categories.
 *
...
/**
 * MyRouter model aliases: canonical name → known aliases.
 * Creates additional DB entries for each alias so that models
 * are findable under any name MyRouter uses internally.
 */
 ...
 *
 * Leaderboard categories are mapped to MyRouter task types:
 * - "text" → default, review, documentation, debugging
 * - "code" → coding
 *
 * Known MyRouter model aliases are also expanded into additional entries.
 *
