 ...
 * trace out of MyRouter into their existing workflow.
 *
 * Secrets are *always* masked on export, regardless of the UI state — see
 * Hard Rule #1 (no credentials in artefacts). The MyRouter capture source
...
const CREATOR_NAME = "MyRouter Traffic Inspector";
