...
function getSchedulerState() {
  if (!globalThis.__myrouterCredentialHC) {
    globalThis.__myrouterCredentialHC = {
      initialized: false,
      sweepTimer: null,
  ...
  return globalThis.__myrouterCredentialHC;
}
...
function isCredentialHealthCheckDisabled(): boolean {
  ...
  const val = process.env.MYROUTER_DISABLE_CREDENTIAL_HEALTH_CHECK;
