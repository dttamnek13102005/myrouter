...
function buildFactors(log: ExplainLog, targetStats: TargetStats): ExplanationFactor[] {
  ...
  factors.push({
    ...
    details: log.comboName
      ...
      : "No combo metadata was persisted, so MyRouter treated this as direct routing.",
  });
  ...
  factors.push({
    ...
    details: "Shows whether MyRouter cache or compression affected cost/latency for this route.",
  });
