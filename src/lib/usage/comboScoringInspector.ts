...
import {
  ...
  type ScoringWeights,
  validateWeights,
} from "@myrouter/open-sse/services/autoCombo/scoring.ts";
import { getModePack } from "@myrouter/open-sse/services/autoCombo/modePacks.ts";
import { getTaskFitness } from "@myrouter/open-sse/services/autoCombo/taskFitness.ts";
import type {
  ComboAutopilotCombo,
