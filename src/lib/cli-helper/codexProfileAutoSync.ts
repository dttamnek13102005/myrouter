...
function isAutoSyncEnabled() {
  // Opt-in, default OFF. Backed by the MYROUTER_AUTO_SYNC_CODEX_PROFILES feature flag
  ...
  return isFeatureFlagEnabled("MYROUTER_AUTO_SYNC_CODEX_PROFILES");
}
...
export async function autoSyncCodexProfilesFromLiveCatalog(
  ...
  // Reuse the CLI generator so automatic sync and `myrouter setup-codex`
