 ...
 *
 * Source of truth for which browser origins may call MyRouter over CORS.
...
const STANDARD_ALLOW_HEADERS =
  "Content-Type, Authorization, x-api-key, anthropic-version, x-myrouter-connection, x-internal-test, accept";
