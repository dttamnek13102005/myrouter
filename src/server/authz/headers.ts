...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-myrouter-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-myrouter-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-myrouter-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-myrouter-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-myrouter-auth-scopes";

/** CLI sends this header so the local process can call management APIs without login. */
export const CLI_TOKEN_HEADER = "x-myrouter-cli-token";
 ...
 * token matches this process's MYROUTER_PEER_STAMP_TOKEN (see
 ...
 */
export const PEER_IP_HEADER = "x-myrouter-peer-ip";
 ...
 * proxy hop (e.g. MyRouter behind nginx / Caddy / Cloudflare Tunnel) is NOT
 ...
 */
export const VIA_PROXY_HEADER = "x-myrouter-via-proxy";
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-myrouter-peer-locality";
