...
import { checkRequestIP } from "@myrouter/open-sse/services/ipFilter.ts";
  ...
  const response = NextResponse.json(
    {
      error: {
        ...
        message:
          ...
          "Refresh the dashboard and retry, or set MYROUTER_PUBLIC_BASE_URL for non-dashboard browser integrations.",
        correlation_id: requestId,
      },
    },
    { status: 403 }
