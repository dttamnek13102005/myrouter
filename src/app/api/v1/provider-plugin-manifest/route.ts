...
import { generateProviderPluginManifest } from "@myrouter/open-sse/config/providerPluginManifestRegistry.ts";
...
import type {
  ...
  ProviderPluginModel,
} from "@myrouter/open-sse/config/providerPluginManifest.ts";
