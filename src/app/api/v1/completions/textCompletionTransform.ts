/**
 * #3571 — `/v1/completions` is the legacy OpenAI Completions API. MyRouter routes
 ...
 * the model they asked for, and the `x-myrouter-model` response header
 ...
 * requested identifier (matching the `x-myrouter-model` response header).
 */
