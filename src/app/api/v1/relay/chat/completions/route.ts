 ...
 * to the internal MyRouter chat completions pipeline.
 */
...
import { getProviderPluginManifestEntryForModel } from "@myrouter/open-sse/config/providerPluginManifestRegistry.ts";
import { getProviderPluginManifestHeader } from "@myrouter/open-sse/config/providerPluginManifestUrl.ts";
