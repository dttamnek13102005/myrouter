...
import { initTranslators } from "@myrouter/open-sse/translator/index.ts";
...
} from "@myrouter/open-sse/utils/earlyStreamKeepalive";
import { resolveKeepaliveThreshold } from "@myrouter/open-sse/utils/keepaliveThreshold";
import {
  admitChatRequest,
  admitChatStructure,
...
export async function POST(request) {
  ...
  try {
    ...
    // typical chat payloads. Toggle off via MYROUTER_LOG_REQUEST_SHAPE=0.
    if (process.env.MYROUTER_LOG_REQUEST_SHAPE !== "0") {
