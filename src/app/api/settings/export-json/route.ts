 ...
 * Exports a legacy MyRouter-compatible JSON backup.
 */
  ...
  try {
    ...
    const exportData: Record<string, unknown> = {
      ...
      _meta: {
        ...
        version: "myrouter-v3-legacy-export",
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="myrouter-legacy-backup-${new Date().toISOString().replace(/[:.]/g, "-")}.json"`,
      },
    });
  } catch (error) {
