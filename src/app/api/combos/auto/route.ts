...
import {
  VALID_VARIANTS,
  type AutoVariant,
} from "@myrouter/open-sse/services/autoCombo/autoPrefix";
import {
  AUTO_SUFFIX_VARIANTS,
  AUTO_TEMPLATE_VARIANTS,
  AUTO_FAMILY_IDS,
} from "@myrouter/open-sse/services/autoCombo/builtinCatalog";
import { parseAutoSuffix } from "@myrouter/open-sse/services/autoCombo/suffixComposition";
...
export async function GET(request: Request) {
  ...
  try {
    const { createVirtualAutoCombo } =
      await import("@myrouter/open-sse/services/autoCombo/virtualFactory");
