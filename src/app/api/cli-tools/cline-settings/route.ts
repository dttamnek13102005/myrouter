...
// Check if MyRouter is configured as OpenAI-compatible provider
const hasMyRouterConfig = (globalState: any) => {
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      hasMyRouter: hasMyRouterConfig(globalState),
...
// POST - Configure Cline to use MyRouter as OpenAI-compatible provider
export async function POST(request: Request) {
  ...
  try {
    ...
    secrets.openAiApiKey = apiKey || "sk_myrouter";
...
// DELETE - Remove MyRouter OpenAI-compatible provider config
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "MyRouter settings removed from Cline",
    });
  } catch (error) {
