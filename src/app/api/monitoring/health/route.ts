...
export async function GET() {
  ...
  try {
    const [
      ...
      import("@myrouter/open-sse/services/rateLimitManager"),
      import("@myrouter/open-sse/services/accountFallback"),
      import("@myrouter/open-sse/services/requestDedup.ts"),
      import("@myrouter/open-sse/services/quotaMonitor.ts"),
      import("@myrouter/open-sse/services/sessionManager.ts"),
