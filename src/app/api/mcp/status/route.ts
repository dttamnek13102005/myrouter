...
import { getAuditStats, queryAuditEntries } from "@myrouter/open-sse/mcp-server/audit";
import {
  isMcpHeartbeatOnline,
  isProcessAlive,
  readMcpHeartbeat,
  resolveMcpHeartbeatPath,
} from "@myrouter/open-sse/mcp-server/runtimeHeartbeat";
import {
  getMcpHttpStatus,
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const scopesEnforced = process.env.MYROUTER_MCP_ENFORCE_SCOPES === "true";
