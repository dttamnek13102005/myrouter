...
export async function GET(request) {
  try {
    ...
    const { getQuotaMonitorSummary } = await import("@myrouter/open-sse/services/quotaMonitor.ts");
    const { getActiveSessions } = await import("@myrouter/open-sse/services/sessionManager.ts");
