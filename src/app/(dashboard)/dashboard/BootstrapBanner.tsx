...
/**
 * Shown when MyRouter was started with auto-generated secrets (zero-config mode).
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="mt-0.5 text-amber-800/80 dark:text-amber-200/80">
          MyRouter auto-generated secure encryption keys on first launch. They are persisted to{" "}
