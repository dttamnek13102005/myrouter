...
const LS_PURCHASE_FILTER = "myrouter:limits:purchaseFilter";
const LS_STATUS_FILTER = "myrouter:limits:statusFilter";
const LS_ENV_FILTER = "myrouter:limits:envFilter";
const LS_PROVIDER_FILTER = "myrouter:limits:providerFilter";
