...
const COMBO_USAGE_GUIDE_STORAGE_KEY = "myrouter:combos:hide-usage-guide";
                      ...
                      <div>
                        <FieldLabelWithHelp
                          ...
                          help={getI18nOrFallback(
                            ...
                            "When quota usage reaches this threshold, MyRouter generates a structured handoff summary before the account is exhausted."
                          )}
                          showHelp={!isExpertMode}
                        />
                        <input
