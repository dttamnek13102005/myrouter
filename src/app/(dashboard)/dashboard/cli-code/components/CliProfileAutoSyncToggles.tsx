...
const CODEX_KEY = "MYROUTER_AUTO_SYNC_CODEX_PROFILES";
const CLAUDE_KEY = "MYROUTER_AUTO_SYNC_CLAUDE_PROFILES";
 ...
 * Reads/writes the MYROUTER_AUTO_SYNC_{CODEX,CLAUDE}_PROFILES feature flags via
