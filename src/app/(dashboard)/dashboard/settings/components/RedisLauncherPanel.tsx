 ...
 * shells out to the same logic exposed via the `myrouter redis` CLI command.
  ...
  return (
    <div className="rounded-xl border border-border bg-surface p-5">
      ...
      <p className="mt-3 text-xs text-text-muted">
        {t(
          "redisLauncherHint",
          "Equivalent to running `myrouter redis up`. The container is named `myrouter-redis` and listens on 127.0.0.1:6379."
        )}
      </p>
    </div>
  );
