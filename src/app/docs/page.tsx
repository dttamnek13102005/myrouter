...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "MyRouter Documentation",
    description:
      "Comprehensive docs for MyRouter AI gateway — setup, API, compression, deployment, and more.",
    type: "website",
    url: "https://myrouter.online/docs",
  },
  twitter: {
    card: "summary_large_image",
    title: "MyRouter Documentation",
    description: "Comprehensive docs for MyRouter AI gateway",
  },
};
...
const featuredLinks = [
  {
    ...
    title: "Quick Start",
    icon: "rocket_launch",
    desc: "Get MyRouter running in 3 minutes",
  },
  {
    href: "/docs/getting-started/auto-combo-guide",
    title: "Auto-Combo Guide",
    icon: "auto_awesome",
    desc: "Let MyRouter pick the best AI for you",
  },
  {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="text-center mb-16 mt-8">
        <h1 className="text-4xl font-bold text-fd-foreground mb-5">MyRouter Documentation</h1>
