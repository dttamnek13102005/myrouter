 ...
 *
 * Serves the MyRouter A2A Agent Card for discovery by other agents.
 ...
 *
 * Returns the MyRouter Agent Card that describes this gateway's
 * capabilities as an A2A agent.
 */
export async function GET() {
  const agentCard = {
    name: "MyRouter AI Gateway",
    description:
    ...
    skills: [
      ...
      },
      {
        ...
        description:
          "Returns the full catalog of 42 MyRouter agent skills (22 API + 20 CLI) " +
