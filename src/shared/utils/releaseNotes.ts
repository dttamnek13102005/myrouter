...
export const NEWS_JSON_URL =
  "https://raw.githubusercontent.com/diegosouzapw/MyRouter/main/news.json";
export const CHANGELOG_RAW_URL =
  "https://raw.githubusercontent.com/diegosouzapw/MyRouter/main/CHANGELOG.md";
export const CHANGELOG_GITHUB_URL =
  "https://github.com/diegosouzapw/MyRouter/blob/main/CHANGELOG.md";
