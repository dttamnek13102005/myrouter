...
import { checkTokenLimits } from "@myrouter/open-sse/services/tokenLimitCounter.ts";
import {
  errorResponse,
  buildErrorBody,
...
const PLAYGROUND_KEY_ID_HEADER = "x-myrouter-playground-key-id";
 ...
 * `x-myrouter-playground-key-id` and we resolve the secret server-side.
 *
