  ...
  const startOAuthFlow = useCallback(
    async (opts?: { grokBrowser?: boolean }) => {
      ...
      try {
        ...
        // show an auth code instead of redirecting back to MyRouter.
        ...
        // 127.0.0.1:<port> callback that MyRouter never listens on (the port is
        ...
        if (provider === "codex" || provider === "openai") {
          ...
          // Remote fallback: use MyRouter's port with the /auth/callback path Windsurf expects.
          ...
          // Behind reverse proxy: use actual origin (e.g., https://myrouter.example.com/callback)
