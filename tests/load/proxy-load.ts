/**
 * MyRouter — k6 Load / Performance Test (T-5)
 *
 ...
 *   k6 run tests/load/proxy-load.js --env BASE_URL=https://llms.myrouter.online
 ...
 *   - MYROUTER_API_KEY env var or --env API_KEY=... set
 */
...
const API_KEY = __ENV.API_KEY || __ENV.MYROUTER_API_KEY || "test-key";
