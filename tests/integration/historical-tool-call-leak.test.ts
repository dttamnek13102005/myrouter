 ...
 *   MYROUTER_URL             — base URL (default http://localhost:20128)
 *   MYROUTER_API_KEY         — API key for auth
...
const BASE_URL = process.env.MYROUTER_URL || "http://localhost:20128";
const MODEL = "default";
const THINKING_MODEL = process.env.TEST_THINKING_GEMINI_MODEL || "gemini/gemini-2.5-flash";
const NUM_HISTORICAL_ROUNDS = 15;

const skip = !API_KEY ? "MYROUTER_API_KEY not set — skipping live test" : undefined;
const skipThinking = !API_KEY ? "MYROUTER_API_KEY not set — skipping live test" : undefined;
