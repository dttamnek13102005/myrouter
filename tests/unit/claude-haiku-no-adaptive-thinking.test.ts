...
import { normalizeClaudeHaikuConstraints } from "@myrouter/open-sse/services/claudeHaikuConstraints.ts";
...
// Several MyRouter paths can still emit these on Haiku targets:
