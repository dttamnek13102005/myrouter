...
import { REGISTRY } from "@myrouter/open-sse/config/providers/index.ts";
import { FREE_MODEL_BUDGETS } from "@myrouter/open-sse/config/freeModelCatalog.data.ts";
...
// fabricated (copied from MyRouter's own Anthropic catalog) and live-verified
