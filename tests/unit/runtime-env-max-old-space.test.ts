 ...
 * MYROUTER_MEMORY_MB instead of relying only on the image-level NODE_OPTIONS
 ...
 * uses (mirroring `myrouter serve`): MYROUTER_MEMORY_MB clamped to [64, 16384],
 * default 512.
 */
...
test("#2939 honors a valid MYROUTER_MEMORY_MB (string or number)", () => {
