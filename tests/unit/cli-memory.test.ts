/**
 * Tests for CLI Memory Sanitization (bin/myrouter.mjs)
 *
 * Tests cover:
...
describe("CLI Memory Limit Sanitization", () => {
  /**
   * Replicate the memory sanitization logic from bin/myrouter.mjs
   */
...
describe("CLI .env File Loading", () => {
  /**
   * Simulate the .env parsing logic from bin/myrouter.mjs
   */
