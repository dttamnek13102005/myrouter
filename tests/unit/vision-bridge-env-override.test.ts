 ...
 *     MyRouter self-loop, Google's Gemini OpenAI-compat endpoint).
...
test("#2232 — MyRouter-internal providers default to self-loop when no env vars set", () => {
  clearEnv();
  // Non-standard prefixes (kr/, if/, pol/, groq/) should use MyRouter self-loop
