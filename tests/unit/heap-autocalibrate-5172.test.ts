 ...
 * spawned with a FIXED 512MB heap default (`myrouter serve`) or with no
 ...
 * ceiling scales with the machine. An explicit `MYROUTER_MEMORY_MB` still wins
...
test("#5172 an explicit MYROUTER_MEMORY_MB still wins over the calibrated default", () => {
