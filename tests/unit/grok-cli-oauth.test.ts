...
const { GrokCliExecutor } = await import("@myrouter/open-sse/executors/grok-cli");
const { getGrokBuildClientVersion } = await import("@myrouter/open-sse/config/grokBuild.ts");
const { resolvePublicCred } = await import("@myrouter/open-sse/utils/publicCreds");
