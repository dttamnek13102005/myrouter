 ...
 *
 * Scope (minimal): only models that MyRouter already references throughout
 ...
 * provider registry. We do NOT restore models MyRouter deliberately curated
 * out (e.g. o1, gpt-4-turbo) nor re-add embedding/TTS/image entries that
 * MyRouter deliberately keeps in their own typed registries
