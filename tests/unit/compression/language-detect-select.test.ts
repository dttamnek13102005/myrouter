...
import { detectCompressionLanguage } from "@myrouter/open-sse/services/compression/languageDetector.ts";
import { cavemanCompress } from "@myrouter/open-sse/services/compression/caveman.ts";
