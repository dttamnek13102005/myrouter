...
process.env.DATA_DIR = mkdtempSync(join(tmpdir(), "myrouter-embeddings-gemini-dim-"));
...
// so MyRouter must forward `outputDimensionality` alongside `dimensions` for Gemini
