...
test("getUsageForProvider returns helpful message when Ollama Cloud has no usage cookie", async () => {
  ...
  const originalOmniCookie = process.env.MYROUTER_OLLAMA_USAGE_COOKIE;
  delete process.env.OLLAMA_USAGE_COOKIE;
  delete process.env.MYROUTER_OLLAMA_USAGE_COOKIE;
  ...
  try {
    ...
    if (originalOmniCookie === undefined) delete process.env.MYROUTER_OLLAMA_USAGE_COOKIE;
    else process.env.MYROUTER_OLLAMA_USAGE_COOKIE = originalOmniCookie;
  }
});
...
test("getUsageForProvider scrapes Ollama Cloud settings quota", async () => {
  ...
  const originalOmniCookie = process.env.MYROUTER_OLLAMA_USAGE_COOKIE;
  delete process.env.OLLAMA_USAGE_COOKIE;
  process.env.MYROUTER_OLLAMA_USAGE_COOKIE = "__Secure-session=test-cookie";
...
test("getUsageForProvider keeps Ollama Cloud reset times aligned to usage tracks", async () => {
  ...
  const originalOmniCookie = process.env.MYROUTER_OLLAMA_USAGE_COOKIE;
  delete process.env.OLLAMA_USAGE_COOKIE;
  process.env.MYROUTER_OLLAMA_USAGE_COOKIE = "test-cookie";
