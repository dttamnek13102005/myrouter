...
// Regression guard for #3883: the @myrouter/opencode-plugin must ship an
...
const PKG_URL = new URL("../../../@myrouter/opencode-plugin/package.json", import.meta.url);
const TSUP_URL = new URL("../../../@myrouter/opencode-plugin/tsup.config.ts", import.meta.url);
