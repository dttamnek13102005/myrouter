 ...
 *
 * MyRouter's runtime Docker image (`Dockerfile`) runs as `USER node` (UID 1000)
 ...
 *
 * This mirrors upstream behavior (decolua/9router) extended to MyRouter's TS
 * fork and MyRouter's existing root-detection (`isRoot()`).
 */
