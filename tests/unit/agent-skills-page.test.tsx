...
function makeSkill(overrides: Partial<AgentSkill> = {}): AgentSkill {
  return {
    ...
    rawUrl: "https://raw.githubusercontent.com/diegosouzapw/MyRouter/refs/heads/main/skills/omni-providers/SKILL.md",
    githubUrl: "https://github.com/diegosouzapw/MyRouter/blob/main/skills/omni-providers/SKILL.md",
    ...overrides,
  };
}
